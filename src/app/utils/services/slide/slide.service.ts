...
export class SlideService {
  ...
  async listAsync() {
    return await this._apiFetchService.requestAsync('GET', 'slide', null);
  }
  ...
  errorNotification(error) {
    ...
    switch (error.status) {
      ...
      case 409:
        this._translateService
          .get('Such an slide is already registered in the system !')
          .subscribe((value) => (errorMessage = value));
        break;
      case 417:
        this._translateService
          .get('Please enter correct slide information !')
          .subscribe((value) => (errorMessage = value));
        break;
      case 404:
        this._translateService
          .get('No slide record found in the system !')
          .subscribe((value) => (errorMessage = value));
        break;
      default:
        this._translateService
